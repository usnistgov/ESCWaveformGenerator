...
%         function this=initdecimationExecutor(this)
...
%         function signalInst=startdecimationExecutor(this,signalNumber)
%            % for I=1:this.numFiles
% %            disp(['signalNumber=',num2str(signalNumber)])
% %            disp(['this.oldFs=',num2str(this.oldFs)])
% %            disp(char(this.outputFiles))
% %            disp(['this.inputFiles{signalNumber}=',(this.inputFiles{signalNumber})])
% %            disp(['this.outputFiles{signalNumber}=',(this.outputFiles{signalNumber})])
% %            disp(['this.freqShifts(signalNumber)=',num2str(this.freqShifts(signalNumber))])
%                 %disp(this)
...
%                 signalInst=initDecimator(signalInst,this.initialSeekSamples,this.samplesPerSegment);
%                 signalInst=decimateFile(signalInst);
%           %  end
%         end
...
%             try
%                 tempSignals=this.signals;
%                 parfor J=1:this.numFiles
%                     %test(J)=this.signals(J);
%                     tempSignals(J)=decimateFile(tempSignals(J));
%                 end
%                 this.signals=tempSignals;
%             catch ME
